...
class TrackingDetailsInput implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'ltl_tracking_detail' => '\ClouSale\AmazonSellingPartnerAPI\Models\FulfillmentInbound\LtlTrackingDetailInput',
        'spd_tracking_detail' => '\ClouSale\AmazonSellingPartnerAPI\Models\FulfillmentInbound\SpdTrackingDetailInput',
    ];
    ...
    {     
        $this->container['ltl_tracking_detail'] = isset($data['ltl_tracking_detail']) ? $data['ltl_tracking_detail'] : null;
        $this->container['spd_tracking_detail'] = isset($data['spd_tracking_detail']) ? $data['spd_tracking_detail'] : null;
    }
