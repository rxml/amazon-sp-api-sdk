...
class SetPrepDetailsRequest implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'msku_prep_details' => '\ClouSale\AmazonSellingPartnerAPI\Models\FulfillmentInbound\MskuPrepDetailInputList',
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['msku_prep_details'] = isset($data['msku_prep_details']) ? $data['msku_prep_details'] : null;
