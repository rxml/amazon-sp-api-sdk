 ...
 * @author   Stefan Neuhaus / ClouSale
 */
class WeightInput implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'WeightInput';
    ...
    protected static $swaggerTypes = [
        'value' => 'string',
        'unit' => '\ClouSale\AmazonSellingPartnerAPI\Models\FulfillmentInbound\UnitOfWeightInput',    
    ];
