...
self::DEEMED_RESELLER_CATEGORY_JE_VOEC,
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['deemed_reseller_category']) && !in_array($this->container['deemed_reseller_category'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'deemed_reseller_category':".$this->container['deemed_reseller_category'].", must be one of '%s'",
    ...
    public function setDeemedResellerCategory($deemed_reseller_category)
    {
        ...
        if (!is_null($deemed_reseller_category) && !in_array($deemed_reseller_category, $allowedValues, true)) {
            throw new \InvalidArgumentException(sprintf("Invalid value for 'deemed_reseller_category':".$deemed_reseller_category.", must be one of '%s'", implode("', '", $allowedValues)));
        }
